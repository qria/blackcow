...
define build.name = "blackcow"
define build.directory_name = "blackcow"
...
define config.save_directory = "blackcow-1564153500"
...
## 맥(Mac)에서 코드 서명을 사용하려면 Apple Developer ID Application이 포함된 문
## 자열로 설정하십시오. 애플(Apple)에서 발행한 ID로 변경하십시오.
